          ...
          <div className="flex flex-col">
            ...
            <div className="bg-orange-50 rounded-2xl p-4 mb-6 text-sm">
              <div className="grid grid-cols-2 gap-x-4 gap-y-2">
                {[["Brand","Vijaykrishna"],["Manufacturer","Sri Lakshminarasimha Ind."],["Origin","Gangavathi, Karnataka"],["Pack Sizes","Coming soon"],["FSSAI No.","Coming soon"],["Best For","Chakli, Dosa, Sweets"]].map(([k,v]) => (
                  <div key={k}>
