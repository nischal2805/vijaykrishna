      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-8 pb-10">
        <div className="lg:grid lg:grid-cols-[55%_45%] lg:gap-12 lg:items-start">
          ...
          <div className="lg:sticky lg:top-24 mb-8 lg:mb-0">
            <div className="bg-gradient-to-br from-[#FEF3C7] to-[#FDE68A] rounded-3xl overflow-hidden flex items-center justify-center shadow-lg border border-orange-100" style={{minHeight: '480px'}}>
              <div className="relative w-[22rem] h-[22rem] sm:w-[26rem] sm:h-[26rem]">
                <Image src="/images/idli.png" alt="Idli Rawa pack" fill className="object-contain drop-shadow-2xl" priority />
              </div>
            </div>
          </div>
