      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-8 pb-10">
        <div className="lg:grid lg:grid-cols-[55%_45%] lg:gap-12 lg:items-start">
          ...
          <div className="lg:sticky lg:top-24 mb-8 lg:mb-0">
            <div className="bg-gradient-to-br from-amber-200 via-yellow-200 to-orange-200 rounded-3xl overflow-hidden flex items-center justify-center shadow-xl border border-orange-200" style={{minHeight: '540px'}}>
          ...
          <div className="flex flex-col">
            ...
            <div className="bg-orange-50 rounded-2xl p-4 mb-6 text-sm">
              <div className="grid grid-cols-2 gap-x-4 gap-y-2">
                {[['Brand','Vijaykrishna'],['Manufacturer','Sri Lakshminarasimha Ind.'],['Origin','Gangavathi, Karnataka'],['Pack Sizes','Coming soon'],['FSSAI No.','Coming soon'],['Best For','Idlis, Soft Dosa']].map(([k,v]) => (
                  <div key={k}>
