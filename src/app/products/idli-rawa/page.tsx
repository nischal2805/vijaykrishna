    ...
    <div className="bg-[#FFF7ED] min-h-screen pt-28">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-8 py-4">
        <nav className="flex items-center gap-2 text-xs text-[#78350F]">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-3 h-3 text-[#F59E0B]/60"><path strokeLinecap="round" strokeLinejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" /></svg>
          <span className="text-[#431407] font-semibold">Idli Rawa</span>
        </nav>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-8 pb-10">
        <div className="lg:grid lg:grid-cols-[55%_45%] lg:gap-12 lg:items-start">
          ...
          <div className="lg:sticky lg:top-24 mb-8 lg:mb-0">
            <div className="bg-gradient-to-br from-amber-300 via-orange-300 to-orange-400 rounded-3xl overflow-hidden flex items-center justify-center shadow-xl border border-orange-300" style={{minHeight: '540px'}}>
              <div className="relative w-[26rem] h-[26rem] sm:w-[30rem] sm:h-[30rem]" style={{ filter: 'brightness(1.12) saturate(1.2) contrast(1.05)' }}>
                <Image src="/images/idli.png" alt="Idli Rawa pack" fill className="object-contain drop-shadow-[0_12px_40px_rgba(0,0,0,0.25)]" priority />
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <h1 className="font-serif text-3xl lg:text-4xl font-bold text-[#431407] leading-tight mb-2">Premium Idli Rawa</h1>
            <p className="text-[#78350F] text-sm mb-4">Perfectly coarse-ground semolina for soft, fluffy idlis every time — no additives, no preservatives.</p>

            {/* Badges */}
            <div className="flex flex-wrap gap-2 mb-5">
              {['100% Natural','Pure Veg','No Preservatives','Stone Ground'].map(b => (
            ...
            <div className="bg-white rounded-2xl border border-orange-100 p-5 mb-5 shadow-sm">
              ...
              <ul className="space-y-2.5">
                {[
                  'Made from carefully selected premium rice',
                  'No additives, colors or preservatives',
                  'Consistent coarse texture for perfect idlis',
            ...
            <div className="bg-orange-50 rounded-2xl p-4 mb-6 text-sm">
              <div className="grid grid-cols-2 gap-x-4 gap-y-2">
                {[['Brand','Vijaykrishna'],['Manufacturer','Sri Lakshminarasimha Ind.'],['Origin','Gangavathi, Karnataka'],['Pack Sizes','1 kg, 20 kg, 50 kg'],['FSSAI No.','Coming soon'],['Best For','Idlis, Soft Dosa']].map(([k,v]) => (
                  <div key={k}>
            ...
            <a
              href="tel:9448190326"
              className="flex items-center justify-center gap-2 bg-[#F59E0B] hover:bg-[#D97706] text-white font-bold py-4 rounded-2xl text-base shadow-lg shadow-orange-200 hover:shadow-xl transition-all duration-200 mb-3"
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                <path fillRule="evenodd" d="M1.5 4.5a3 3 0 0 1 3-3h1.372c.86 0 1.61.586 1.819 1.42l1.105 4.423a1.875 1.875 0 0 1-.694 1.955l-1.293.97c-.135.101-.164.249-.126.352a11.285 11.285 0 0 0 6.697 6.697c.103.038.25.009.352-.126l.97-1.293a1.875 1.875 0 0 1 1.955-.694l4.423 1.105c.834.209 1.42.959 1.42 1.82V19.5a3 3 0 0 1-3 3h-2.25C8.552 22.5 1.5 15.448 1.5 6.75V4.5Z" clipRule="evenodd" />
              </svg>
              Call to Enquire — 94481 90326
            </a>
          ...
          <div className="grid lg:grid-cols-2 gap-10">
            ...
            <div>
              ...
              <p className="text-[#78350F] text-sm leading-relaxed mb-3">
                Our Idli Rawa is made from carefully selected rice grains that are soaked, ground, and dried to achieve the perfect coarse consistency. Unlike finely milled flour, the granular texture of Idli Rawa creates the characteristic soft and spongy interior of well-made idlis.
              </p>
              <p className="text-[#78350F] text-sm leading-relaxed">
                Processed at Sri Lakshminarasimha Industries in Gangavathi — the heart of Karnataka&apos;s rice belt — every batch maintains the same quality standards that families have trusted for years. Zero additives. Zero preservatives. Just pure grain.
              </p>
            </div>
            ...
            <div>
              ...
              <ol className="space-y-2.5">
                {[
                  'Wash and soak Idli Rawa in water for 4–6 hours.',
                  'Soak urad dal separately for 4–6 hours, then grind to a smooth batter.',
                  'Squeeze excess water from the rawa and mix well into the urad dal batter.',
                  'Add salt and ferment overnight (8–10 hours) in a warm place.',
                  'Steam in greased idli moulds for 10–12 minutes. Serve hot.',
                ].map((step, i) => (
