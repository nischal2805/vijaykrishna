  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10 pt-28">
      ...
      <div className="space-y-4 mb-10">
        ...
        <a href="mailto:vkagrofood28@gmail.com" className="flex items-center gap-4 bg-white rounded-2xl p-4 shadow-sm border border-orange-100 hover:shadow-lg hover:border-[#F59E0B]/40 hover:-translate-y-0.5 transition-all duration-200">
          <div className="w-11 h-11 rounded-full bg-[#F59E0B]/10 flex items-center justify-center text-[#F59E0B] flex-shrink-0">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="currentColor" className="w-5 h-5">
          ...
          <div>
            ...
            <p className="font-bold text-[#431407] text-sm">vkagrofood28@gmail.com</p>
          </div>
        </a>
      ...
      {/* Products CTA */}
      <div className="bg-[#431407] rounded-2xl p-6 text-center">
        <h3 className="font-serif font-bold text-xl mb-2 text-white">Explore Our Products</h3>
        <p className="text-orange-200/70 text-sm mb-4">Premium Idli Rawa, Ragi Flour &amp; Rice Flour</p>
        <Link
          href="/products"
          className="inline-block bg-[#F59E0B] hover:bg-[#D97706] text-white font-bold px-6 py-2.5 rounded-full text-sm transition-colors shadow-lg"
        >
          View Products
        </Link>
      </div>
